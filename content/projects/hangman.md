...
Задача - реализовать игру "виселица" на Go. Интерфейс - консольный. Описание правил игры на [Википедии](https://ru.wikipedia.org/wiki/%D0%92%D0%B8%D1%81%D0%B5%D0%BB%D0%B8%D1%86%D0%B0_(%D0%B8%D0%B3%D1%80%D0%B0)).

Комментарии по проекту - [https://www.youtube.com/watch?v=kqLklwFjr5g](https://www.youtube.com/watch?v=kqLklwFjr5g).

## Что нужно знать

- [Go](../technologies/go.md#базовый-синтаксис) - базовый синтаксис
...
Даже самая маленькая программа в Go содержит хотя бы 1 функцию и она является точкой входа в программу.

Если у вас уже есть опыт в ООП, предлагаю написать этот проект в ООП-стиле в контексте Go, разбив всю логику на части и реализовав их в методах нескольких структур.

Если такого опыта нет, можно реализовать всё в процедурном стиле в виде функций.
...
- Использование массивов. Лучше применять структуры данных slice и set
