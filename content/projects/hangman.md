...
- [Java](../technologies/go.md#базовый-синтаксис) - базовый синтаксис
...
Если у вас уже есть опыт в ООП, предлагаю написать этот проект в ООП-стиле, разбив всю логику на части и реализовав их в методах нескольких структур.
