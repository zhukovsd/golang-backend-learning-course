...
- Docker в контексте Go - Dockerfile для сборки и запуска приложения
...
- Практика:
  - Проект #6 ["Облачное хранилище"](../projects/cloud-file-storage.md) - паковка Go приложения в Docker образ, написание Docker Compose стека с базами данных (SQL, MinIO, Redis), деплой
  - Проект #7 ["Планировщик задач"](../projects/task-tracker.md) - упаковка Go приложения в Docker образ, написание своего Docker Compose стека (Goсервисы, хранилища), сборка образов в CI/CD пайплайне, деплой
