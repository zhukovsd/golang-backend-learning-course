...
Подробности о деплое каждого проекта описаны в ТЗ, ниже приведу примерные шаги эволюции деплоя бэкенд Go приложений:

- Вручную - установка Go на удалённый сервер, установка необходимых инструментов (например, базы данных), собранного приложения в веб-сервер.
...
- Развертывание go приложения с http сервером
- Docker
